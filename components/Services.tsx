...
const TiltCard = ({ service, index }: { service: typeof servicesData[0], index: number }) => {
  ...
  return (
    <motion.div
      ...
      className="group relative min-h-[130px] p-8 rounded-2xl cursor-pointer overflow-hidden transition-colors duration-500 bg-[#1c1c1c] flex flex-col justify-center items-center text-center shadow-lg"
    >
