...
const floatingIcons = [
  ...
  { 
    id: 'chat', cx: 1620, cy: 980, delay: 2.5, 
  ...
  { 
    id: 'linkedin', cx: 880, cy: 880, delay: 0.8, 
  ...
  { 
    id: 'email', cx: 1040, cy: 880, delay: 1.8, 
    ...
    <svg viewBox="0 0 1920 1080" preserveAspectRatio="xMidYMid slice" className="absolute inset-0 w-full h-full z-10 pointer-events-none">
      ...
      {floatingIcons.map((icon) => (
        <motion.g
          ...
          animate={{ y: [-8, 8, -8] }}
          transition={{ duration: 7, repeat: Infinity, ease: "easeInOut", delay: icon.delay }}
        >
          <rect
            x={icon.cx - 32}
            y={icon.cy - 32}
