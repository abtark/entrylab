...
export default function About() {
  ...
  return (
    <section id="about" className="relative py-32 bg-[#111111] overflow-hidden flex justify-center items-center">
      {/* Custom Styles for Right-to-Left Gradient Animation */}
      ...
      {/* Floating Objects (Outside Container, inside section) */}
      <div className="absolute inset-0 max-w-7xl mx-auto w-full h-full pointer-events-none z-0">
        {/* Circle 1 */}
        <motion.div 
          animate={{ y: [0, -30, 0], x: [0, 15, 0] }}
          transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
          className="absolute top-[10%] left-[5%] w-32 h-32 md:w-48 md:h-48 rounded-full bg-gradient-to-br from-[#00AAFF]/40 to-blue-600/40 blur-3xl will-change-transform"
        />
        {/* Rectangle 1 */}
        <motion.div 
          animate={{ y: [0, 40, 0], rotate: [0, 10, 0] }}
          transition={{ duration: 10, repeat: Infinity, ease: "easeInOut" }}
          className="absolute top-[20%] right-[5%] w-24 h-24 md:w-40 md:h-40 rounded-2xl bg-gradient-to-tr from-purple-500/30 to-pink-500/30 blur-3xl will-change-transform"
        />
        {/* Circle 2 */}
        <motion.div 
          animate={{ y: [0, -20, 0], x: [0, -20, 0] }}
          transition={{ duration: 7, repeat: Infinity, ease: "easeInOut", delay: 1 }}
          className="absolute bottom-[10%] right-[15%] w-28 h-28 md:w-36 md:h-36 rounded-full bg-gradient-to-tl from-cyan-400/30 to-teal-500/30 blur-3xl will-change-transform"
        />
        {/* Rectangle 2 */}
        <motion.div 
          animate={{ y: [0, 30, 0], rotate: [0, -15, 0] }}
          transition={{ duration: 9, repeat: Infinity, ease: "easeInOut", delay: 0.5 }}
          className="absolute bottom-[20%] left-[10%] w-20 h-20 md:w-32 md:h-32 rounded-xl bg-gradient-to-br from-indigo-500/30 to-[#00AAFF]/30 blur-3xl will-change-transform"
        />
      </div>

      {/* MAIN CONTAINER (Glassmorphism) */}
      <div className="relative z-10 w-full max-w-4xl mx-auto px-6">
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-14 flex flex-col items-center shadow-[0_8px_32px_rgba(0,0,0,0.3)]">
          ...
          <div className="w-full mb-10 flex justify-center">
            <MagneticItem className="w-full max-w-md">
              <img 
          ...
          <motion.div 
            ...
            className="w-full flex flex-col items-center text-center space-y-6 text-white/90 text-lg md:text-xl font-medium leading-relaxed max-w-3xl"
          >
            ...
            <motion.p variants={itemVariants} className="pt-4 text-[#00AAFF] font-semibold text-xl md:text-2xl tracking-wide">
